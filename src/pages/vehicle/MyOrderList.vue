    ...
    <div class="con" v-for="(item,index) of data" :key="index">
      <div class="content">
        <div class="ve-message">
          <div class="item-tab">{{item.driverName}}</div>
          <div class="item-tab">{{item.carNumber}}</div>
        </div>
        <div class="ve-message">
          <div class="item-tab">{{item.lesseeBeginDate}}</div>
          <div class="item-tab">{{item.lesseeEndDate}}</div>
        </div>
      </div>
      <div class="message">
